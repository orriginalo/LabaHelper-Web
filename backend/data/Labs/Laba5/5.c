    ...
    case WM_PAINT:
        {
            ...
            SelectObject(hdc, hPen);
            SelectObject(hdc, hBrush);
            Ellipse(hdc, 400 - r1, 200 - r1, 400 + r1, 200 + r1);
            Ellipse(hdc, 400 - r2, 200 + r1, 400 + r2, 200 + r1 + 2 * r2);
            Ellipse(hdc, 400 - r3, 200 + r1 + 2 * r2, 400 + r3, 200 + r1 + 2 * r2 + 2 * r3);

            // Руки
            MoveToEx(hdc, 400 - r2, 200 + r1 + r2, NULL);
            LineTo(hdc, 400 - r2 - 20, 200 + r1 + r2 - 20);
